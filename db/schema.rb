...
ActiveRecord::Schema.define(version: 2019_12_29_044350) do
  ...
  create_table "products", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["customer_id_id"], name: "index_products_on_customer_id_id"
    t.index ["size_id_id"], name: "index_products_on_size_id_id"
